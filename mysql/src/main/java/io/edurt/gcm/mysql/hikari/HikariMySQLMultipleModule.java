...
public class HikariMySQLMultipleModule
        extends PrivateModule
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HikariMySQLMultipleModule.class);

    private final String configuration;

    public HikariMySQLMultipleModule(String configuration)
    {
        this.configuration = configuration;
    }

    public HikariMySQLMultipleModule()
    {
    ...
    protected void configure()
    {
        ...
        install(new MyBatisModule()
        {
            ...
            protected void initialize()
            {
                ...
                bindDataSourceProvider(new HikariMySQLProvider(configuration));
        ...
        new ResolverUtil<>()
                ...
                .getClasses()
                .forEach(HikariMySQLMultipleModule.this::expose);
    }
}
