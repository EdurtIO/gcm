...
{
    @GetMapping(value = "/query/{path}")
    public String testCase1(@PathVariable(value = "path") String path,
            @RequestParam(value = "value") String value)
    {
        return String.join("-", path, value);
    }

    @GetMapping(value = "/query/info/{id}")
    public String testCase(@RequestParam(value = "value") String value,
